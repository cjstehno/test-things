...
public final class JacksonJsonSerdesVerifiers {
    ...
    public static void verifyDeserialization(final String json, final Object expectedObject) {
        Verifiers.verifyDeserialization(new JacksonJsonSerdes(), json, expectedObject);
    }

    public static void verifySerdes(final Object object, final String json) {
        Verifiers.verifySerdes(new JacksonJsonSerdes(), object, json);
    }
}
